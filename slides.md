...
<GlowBackground>
  <h1 class="text-6xl md:text-8xl font-bold tracking-tight text-white">Cursor Meetup Guangzhou</h1>
</GlowBackground>
...
<div class="flex flex-col gap-y-2 mt-6 max-w-2xl mx-auto text-base">
  <div class="flex items-center p-1">
    ...
    <span class="text-gray-300">Jax：Cursor 武装升级：MCP 应用与自建</span>
  </div>
  <div class="flex items-center p-1">
    <span class="w-6 mr-2 text-gray-600 font-mono">2.</span>
    <span class="text-gray-300">juju：设计也能开挂？Cursor + MCP 联手打造智能新体验</span>
  </div>
  <div class="flex items-center p-1">
    <span class="w-6 mr-2 text-gray-600 font-mono">3.</span>
    <span class="text-gray-300">Cursor 官方视频环节</span>
  </div>
  <div class="flex items-center p-1">
    <span class="w-6 mr-2 text-gray-600 font-mono">4.</span>
    <span class="text-gray-300">Bolyn：Cursor 在高校科研学习中的应用实践</span>
  </div>
  <div class="flex items-center p-1">
    <span class="w-6 mr-2 text-gray-600 font-mono">5.</span>
    <span class="text-gray-300">AlphaWan：与Cursor的恋爱史：Meetup 现场社区互动工具</span>
  </div>
  <div class="flex items-center p-1">
